...
class Com_compatibilityInstallerScript extends \FOF40\InstallScript\Component
{
	/**
	 ...
	 * @var   string
	 */
	public $componentName = 'com_compatibility';
	...
	protected function renderPostInstallation(ComponentAdapter $parent): void
	{
		...
		?>
		<h2>Akeeba Version Compatiblity</h2>
	...
	{
		?>
		<h2>Akeeba Version Compatibility Uninstalation</h2>
		<?php
